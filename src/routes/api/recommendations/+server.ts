...
This is a research prototype, not an inspection or a building safety certification. BRS is a model score, not a probability of safety. Default wind fragility is illustrative and uncalibrated. Floors, length, and width are context only and do not affect the model scores. Fault distance is user-entered.
